...
export const createAppointment = async (appopintment: CreateAppointmentParams) => {
    try {
...
export const updateAppointment = async ({ 
    ...
    try {
        ...
        : `We regret to inform you that your appointment for ${formatDateTime(appointment.schedule!).dateTime} has been cancelled due to the following reason:  
